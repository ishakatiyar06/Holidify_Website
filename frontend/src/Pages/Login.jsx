...
const Login = () => {
  ...
  const LoginFunction = async (e) => {
    // if (name && password && name == "admin" && password == "12345678") {
    //   sessionStorage.setItem("token", "LoggedInSuccessfully");
    //   navigate("/home");
    // }
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('../src/assats/bg.jpg')" }}
    >
      <div className="bg-slate-800 border border-slate-600 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative transition-all duration-200">
        ...
        <form action="" onSubmit={(e) => LoginFunction(e)}>
